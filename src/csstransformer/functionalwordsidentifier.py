...
class FunctionalWordsIdentifierFactory(object):

    class FunctionalWordsIdentifierImpl(object):
        ...
        def __init__(self):
            ...
            self.identifier = dict(
                [(word, True) for word in s.split(' ')]
            )
            pass

        def is_functional_word(self, word):
            return word.lower() in self.identifier

    __impl = FunctionalWordsIdentifierImpl()
